...
export function useSalesColumns(
  ...
  setOpenReassignWindow: React.Dispatch<React.SetStateAction<boolean>>
) {
  return useMemo(
    () => generateSalesColumns(setActionItem, setOpenResetPasswordWindow, setOpenReassignWindow),
    [setActionItem, setOpenResetPasswordWindow, setOpenReassignWindow]
  );
}
